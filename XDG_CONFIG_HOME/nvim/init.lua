-- Plugins to look at:
--   + lazy.nvim - lazy loading package manager
--   + scope.nvim - scope buffers to tabs
-- Install packer
...
require('packer').startup(function(use)
  ...
  use {'akinsho/bufferline.nvim', requires = 'nvim-tree/nvim-web-devicons'} -- Fancier buffer/tabline
...
-- Set bufferline as buffer/tab line
...
-- TODO: set keymaps. probably want:
--   + BufferLineCycleNext
--   + BufferLineCyclePrev
--   + bnext
--   + bprev
--   Also look into scope and see if that changes things
...
vim.keymap.set('n', '<leader>sr', require('telescope.builtin').git_files, { desc = '[S]earch files in git [R]epo' })
vim.keymap.set('n', '<leader>sh', require('telescope.builtin').help_tags, { desc = '[S]earch [H]elp' })
vim.keymap.set('n', '<leader>sw', require('telescope.builtin').grep_string, { desc = '[S]earch current [W]ord' })
vim.keymap.set('n', '<leader>sg', require('telescope.builtin').live_grep, { desc = '[S]earch by [G]rep' })
vim.keymap.set('n', '<leader>sd', require('telescope.builtin').diagnostics, { desc = '[S]earch [D]iagnostics' })

vim.keymap.set('n', '<leader>key', require('telescope.builtin').keymaps, { desc = 'Show [KEY]map info' })
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'bash', 'c', 'cpp', 'css', 'dockerfile', 'go', 'html', 'ini', 'json', 'latex', 'lua', 'markdown', 'nix', 'python', 'rust', 'toml', 'typescript', 'yaml', 'zig', 'help', 'vim' },
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>fs', vim.lsp.buf.signature_help, '[F]unction [S]ignature help')
